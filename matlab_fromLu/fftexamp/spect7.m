...
amp1=line('Xdata',t/N,'Ydata',a,'color','r','LineStyle','o','MarkerSize',5);
pow1=line('Xdata',f,'Ydata',Pa/Pam,'color','b','LineStyle','+','MarkerSize',5);
...
xlabel('Normalised frequency & time scale ');
amp2=line('Xdata',t/N,'Ydata',aa,'color','r','LineStyle','o','MarkerSize',5);
pow2=line('Xdata',f,'Ydata',Paf/Pafm,'color','b','LineStyle','+','MarkerSize',5);
% plots dft results;
pause(3);

figure(f0+2);
plot(f,abs((Paf-Pa)/Pam),'o'); % plots fractional error in power spectrum;
