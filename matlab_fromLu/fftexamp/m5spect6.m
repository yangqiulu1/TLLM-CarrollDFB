...
rl2=line('Xdata',f,'Ydata',real(AAW/norm),'color','r','Marker','+','MarkerSize',4);
im2=line('Xdata',f,'Ydata',imag(AAW/norm),'color','b','Marker','o','MarkerSize',4);
		% plots dft results;
pause(3)
