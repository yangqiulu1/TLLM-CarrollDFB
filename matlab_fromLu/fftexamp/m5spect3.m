...
f1=line('Xdata',0.25,'Ydata',1,'color','r','Marker','o','MarkerSize',4);
f2=line('Xdata',0.25+df,'Ydata',1,'color','r','Marker','o','MarkerSize',4);
if df>1/512;
...
rl2=line('Xdata',t,'Ydata',abs(aa),'color','r','Marker','o','MarkerSize',4);
		% plots DFT results;
pause(3);
