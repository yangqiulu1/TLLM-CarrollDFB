...
rl1=line('Xdata',ta,'Ydata',real(a0),'color','r','LineStyle','-','MarkerSize',6);
%im1=line('Xdata',ta,'Ydata',imag(a0),'color','b','LineStyle','o','MarkerSize',4);%imag. part if required
pause(3);
...
centre=line('Xdata',0,'Ydata',0,'color','b','LineStyle','+','MarkerSize',6);
...
%im2=line('Xdata',t,'Ydata',imag(aa),'color','b','LineStyle','--','MarkerSize',4);%imag part if required.
		% plots DFT results;
pause(3);
