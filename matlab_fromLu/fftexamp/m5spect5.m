...
rl2=line('Xdata',f,'Ydata',real(AA/norm),'color','r','Marker','+','MarkerSize',4);
im2=line('Xdata',f,'Ydata',imag(AA/norm),'color','b','Marker','o','MarkerSize',4);
		% plots dft results;
pause(3)
...
rl2=line('Xdata',f,'Ydata',real(-A+AA/norm),'color','r','Marker','+','MarkerSize',4);
im2=line('Xdata',f,'Ydata',imag(-A+AA/norm),'color','b','Marker','o','MarkerSize',4);
