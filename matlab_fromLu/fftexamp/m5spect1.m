...
figure;
po1=line('Xdata',f,'Ydata',Paf,'color','g','Marker','.','MarkerSize',4);
poA=line('Xdata',f0,'Ydata',1,'color','r','Marker','o','MarkerSize',4);
...
rl2=line('Xdata',t,'Ydata',real(aa),'color','r','Marker','+','MarkerSize',4);
im2=line('Xdata',t,'Ydata',imag(aa),'color','b','Marker','o','MarkerSize',4);
		% plots DFT results;
pause(3);
