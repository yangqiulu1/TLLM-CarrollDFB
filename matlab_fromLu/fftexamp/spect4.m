...
tin=input('try 1 first then try 2; press enter for default 1 ');
...
rl1=line('Xdata',f,'Ydata',real(AA),'color','r','LineStyle','+','MarkerSize',4);
im1=line('Xdata',f,'Ydata',imag(AA),'color','b','LineStyle','o','MarkerSize',4);
		% plots dft results;
