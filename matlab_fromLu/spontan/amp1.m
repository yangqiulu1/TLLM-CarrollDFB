...
disp('First demo of spontaneous emission shows');
disp('    how noise builds up with distance');
disp('NOISE IS WHITE IN THIS RUN');
disp('No gain or loss so forward field propagates as:-');
...
Pl=10*log10(P);     % Pl/Pfav作者放这里似乎也没用上……
Pfl=10*log10(Pf)-50;  % 为什么要-50？
figure(f0+n-1);
subplot(1,2,1);
