...
if isempty(kL)
    kappa = input('enter complex coupling coefficient (default 30 + j*0)  ');
    if isempty (kappa);
        kappa = 30 + j*0;
    end;
    kL = kappa*L*0.0001;  % factor of 0.0001 to get dimensions right for kL;
end;   
% Left facet section;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
eps=0.04;		 % gain saturation factor
